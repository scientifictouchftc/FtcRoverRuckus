...
@Autonomous(name = "DepotV2")
public class DepotV2 extends LinearOpMode{
...

    {
        ...
        if ( location.equals("middle")) {
            ...
            encoderDrive(.5,-5,5,30);// turn to crater
            ...
            encoderDrive(.5,-4,4,30); // turn to depot
            encoderDrive(.5,14,14,30);
            ...
            encoderDrive(.5,-8,8,30); // turn to depot

            encoderDrive(.7,-18,-18,30); // drive to depot

...
@Autonomous(name = "CraterV3")
public class CraterV3 extends LinearOpMode{
...
// Positive goes down
       ...
       // String location = "right";
        ...
        if ( location.equals("middle")) {
            ...
            encoderDrive(1,24,24,30); //hitting mineral

        } else if(location.equals("right")) {
            encoderDrive(.3,3.5,3.5,30);  //move foreward
            encoderDrive(.6,8,-8,30); //Turn Right
            encoderDrive(.7,34,34,30); // Hit to mineral

        } else { //moving to left
            encoderDrive(.8,10,10,30); //move forward
            encoderDrive(.6,-8,8,30); //turn to mineral
            encoderDrive(.6,22,22,30);// hitting mineral
